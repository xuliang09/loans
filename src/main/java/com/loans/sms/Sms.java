...
public class Sms
{
    ...
    static final String phoneNumbers = "17625997097";

    static final String signName = "许亮";

    public static SendSmsResponse sendSms(String name, String phoneNumber)
            throws ClientException
    {
        ...
        request.setTemplateParam("{\"name\":" + name + ", \"PhoneNumbers\":"
                + phoneNumber + "}");
